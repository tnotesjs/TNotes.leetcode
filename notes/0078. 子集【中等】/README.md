...
- [5. 对比：s.2 和 s.3](#5-对比s2-和-s3)
  - [5.1. s.2 是二叉决策树 `Binary Decision Tree`](#51-s2-是二叉决策树-binary-decision-tree)
  - [5.2. s.3 是多叉树遍历 `N-ary Tree Traversal`](#52-s3-是多叉树遍历-n-ary-tree-traversal)
  - [5.3. 小结](#53-小结)
