---
id: 7fd3a4b4-f65a-4d62-84e5-0691e356a680
---

## 1. 📝 题目描述

- [leetcode](https://leetcode.cn/problems/watering-plants-ii/)
...
- 时间复杂度：$O(n)$，其中 n 是植物数组的长度
- 空间复杂度：$O(1)$，只使用了常数级别的额外空间

算法思路：

- Alice 从左向右浇水，Bob 从右向左浇水，使用双指针模拟
- 每次浇水前检查剩余水量是否足够，不够则补水并计数
- 当两指针相遇时（奇数长度），由水量更多的一方浇最后一棵植物
