...
- 空间复杂度：O(1)
- **流程说明：**
  - ![](https://cdn.jsdelivr.net/gh/Tdahuyou/imgs@main/2024-11-10-18-40-59.png)
...
- **变量说明：**
  ...
  - `k` 是一个紧跟着 `i` 的辅助指针
- **流程说明：**
- ![](https://cdn.jsdelivr.net/gh/Tdahuyou/imgs@main/2024-11-10-18-55-21.png)
...
- 提交记录：虽然能够通过一些示例，但 `nums[i]` 一旦出现负数或者大于 9 的数，这法子就行不通了。
  - ![](https://cdn.jsdelivr.net/gh/Tdahuyou/imgs@main/2024-11-10-19-07-44.png)
