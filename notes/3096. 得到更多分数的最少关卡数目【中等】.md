---
id: 15c34680-1180-45d2-a801-5d402e5c518e
---

## 1. 📝 题目描述

- [leetcode](https://leetcode.cn/problems/minimum-levels-to-gain-more-points/)
...
- 先计算总分（1 得 1 分，0 扣 1 分）
- 枚举 Alice 完成的关卡数 i（从 1 到 n-1），计算 Alice 的分数
- Bob 的分数 = 总分 - Alice 的分数，如果 Alice > Bob 则返回 i+1
