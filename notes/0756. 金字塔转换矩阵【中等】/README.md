...
![img](https://cdn.jsdelivr.net/gh/tnotesjs/imgs@main/2025-09-15-20-28-39.png)
...
![img](https://cdn.jsdelivr.net/gh/tnotesjs/imgs@main/2025-09-15-20-28-44.png)
...
- 时间复杂度：$O(A^n)$，其中 A 是字母表大小，n 是 bottom 长度
- 空间复杂度：$O(n^2)$，递归栈深度
