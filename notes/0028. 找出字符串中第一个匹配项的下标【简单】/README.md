# [0028. 找出字符串中第一个匹配项的下标【简单】](https://github.com/Tdahuyou/TNotes.leetcode/tree/main/notes/0028.%20%E6%89%BE%E5%87%BA%E5%AD%97%E7%AC%A6%E4%B8%B2%E4%B8%AD%E7%AC%AC%E4%B8%80%E4%B8%AA%E5%8C%B9%E9%85%8D%E9%A1%B9%E7%9A%84%E4%B8%8B%E6%A0%87%E3%80%90%E7%AE%80%E5%8D%95%E3%80%91)
...
- [4. 🎯 Solutions.1 - 暴力解法 - 调用原生 API - indexOf](#4--solutions1---暴力解法---调用原生-api---indexof)
- [5. 📒 KMP 算法简介](#5--kmp-算法简介)
- [6. 🎯 Solutions.2 - 暴力解法](#6--solutions2---暴力解法)
- [7. 🎯 Solutions.3 - KMP](#7--solutions3---kmp)
...
## 4. 🎯 Solutions.1 - 暴力解法 - 调用原生 API - indexOf
  ...
  - **步骤 1. 初始化 next 数组**：这部分代码构建了 PMT（或称 next 数组）。通过遍历模式串，计算每个位置的 **最大相同前后缀长度**，从而指导后续匹配时如何移动模式串。
    - 什么是“最大相同前缀”？
      ...
      - 示例：`needle = "ababca"` 对应的 next 数组为 `[0, 0, 1, 2, 0, 1]`。
        - ![](https://cdn.jsdelivr.net/gh/tnotesjs/imgs@main/2024-11-17-12-17-38.png)
      - 官方提供的示例：
        - ![](https://cdn.jsdelivr.net/gh/tnotesjs/imgs@main/2024-11-17-12-27-49.png)
