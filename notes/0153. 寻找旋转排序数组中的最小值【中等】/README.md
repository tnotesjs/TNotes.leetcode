...
- [4. `pivot = low + ((high - low) >> 1)`、`pivot = (high + low) >> 1` 这两种写法等效吗？【AI】](#4-pivot--low--high---low--1pivot--high--low--1-这两种写法等效吗ai)
...
## 4. `pivot = low + ((high - low) >> 1)`、`pivot = (high + low) >> 1` 这两种写法等效吗？【AI】
